...
<head>
    ...
    <style>
        body {
            background-color: #cce7ff; /* Biru lembut */
        ...
        th, td {
            border: 1px solid #66b3ff; /* Biru lebih gelap untuk garisan */
            padding: 10px;
            text-align: left;
        }
        th {
            background-color: #66b3ff; /* Biru lebih gelap untuk latar belakang tajuk */
            color: white;
        }
        .btn-delete {
            background-color: #ff6666; /* Merah lembut */
            color: white;
            border: none;
            padding: 5px 10px;
            cursor: pointer;
        ...
        .btn-delete:hover {
            background-color: #ff4d4d; /* Merah lebih gelap apabila hover */
        }
        .date-dropdown {
            margin-bottom: 20px;
        }
        h2 {
            color: #004085; /* Biru gelap untuk tajuk */
        }
    </style>
</head>
<body>
        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <?php if (!$is_parent): ?>
                        <td>
                            <form action="proses_padam.php" method="POST" style="display:inline;">
